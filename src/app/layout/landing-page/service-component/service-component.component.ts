...
import { CVData } from './cvData.model';
...
generatePdf(): void {
  ...
  // generatePdf(): void {
  //   const imageUrl = this.selectedImage ? URL.createObjectURL(this.selectedImage) : ''; // Créez l'URL de l'image
  //   console.log('Image URL:', imageUrl); // Vérifiez l'URL de l'image dans la console
  //   this.candidatesService.generateCv({...this.cvData, selectedImage: imageUrl}).subscribe((pdfBlob: Blob) => {
  //     this.pdfBlob = pdfBlob;
  //     // Ajoutez le reste de votre logique si nécessaire
  //   });
  // }
